 ...
 * @author marro
 */
public class eliminarDeporte extends javax.swing.JFrame {

    /**
     * Creates new form eliminarDeporte
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ELIMINAR DEPORTE");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        JOptionPane.showMessageDialog(null," En este Menú se podrán Eliminar los Deportes ");
    ...
    private void BTELIMINARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTELIMINARActionPerformed
        ...
        try{
            PreparedStatement pst=cn.prepareStatement("DELETE FROM deportes WHERE Descripcion='"+jTextField1.getText()+"';");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eliminarDeporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminarDeporte().setVisible(true);
            }
        });
    }
