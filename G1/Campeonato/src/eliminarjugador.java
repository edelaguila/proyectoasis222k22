...
public class eliminarjugador extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        JOptionPane.showMessageDialog(null," En este Menú se podrán Eliminar los Jugadores, poniedno su ID.");
    ...
    private void BTELIMINARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTELIMINARActionPerformed
        ...
        try{
            PreparedStatement pst=cn.prepareStatement("DELETE FROM jugador WHERE Nombre='"+jTextField1.getText()+"';");
