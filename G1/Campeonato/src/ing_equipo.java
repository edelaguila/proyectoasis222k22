 ...
 * @author marro
 */
public class ing_equipo extends javax.swing.JFrame {

    /**
     * Creates new form ing_equipo
     */
    public ing_equipo() {
        initComponents();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        JOptionPane.showMessageDialog(null," En este Menú se podrán ingresar los datos de los Equipos.");
    ...
    private void BTINGRESARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTINGRESARActionPerformed
       conectar cc=new conectar();
        ...
        try{
            PreparedStatement pst=cn.prepareStatement("INSERT INTO equipos(Nombre, Id_Deporte ) VALUES(?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ing_equipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ing_equipo().setVisible(true);
            }
        });
    }
