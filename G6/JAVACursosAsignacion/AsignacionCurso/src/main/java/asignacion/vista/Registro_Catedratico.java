 ...
 * @author Diana
 */
public class Registro_Catedratico extends javax.swing.JFrame {

    /**
     * Creates new form Registro_Catedratico
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registro_Catedratico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registro_Catedratico().setVisible(true);
            }
        });
    }
